                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl">
                  {category.projects.map((project) => (
                    <Link
                      ...
                      className="glass-card p-6 group hover:border-primary/60 hover:shadow-md hover:shadow-primary/10 transition-all duration-300 flex flex-col h-full scroll-mt-28"
                    >
                      {/* Header */}
